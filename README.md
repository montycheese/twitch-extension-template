...
Once you have the Dev rig started up, follow these steps to get this project setup.
...
To run the checkstyle, run `yarn lint` to start the linter to see all checkstyle errors in the code. use the --fix flag to
automatically fix safe checkstyle errors/warnings.
## Usage
...
### Dev Rig required files
Add the following to your workspace to import your project into the Dev Rig

Add the following text to a file called Sengames.json
```
{
  ...
  "extensionViews": [
    {
      ...
      "label": "overlay",
      "channelId": "79606633",
      "configurationAnchor": "video_overlay",
      "displayChannelName": "montycheese",
      "type": "video_overlay",
      "features": {
        "isChatEnabled": false
      },
  ...
  "manifest": {
    ...
    "assetUrls": [],
    "authorName": "montycheese",
    "bitsEnabled": false,
    "canInstall": true,
    "configUrl": "http://localhost:8080/config.html",
    ...
    "iconUrl": "",
    "iconUrls": {},
    "id": "pfo4osx6zryo4kdo5oabxz8pyv84es",
    ...
    "summary": "TODO",
    "supportEmail": "montanawong@gmail.com",
    "vendorCode": "",
    "version": "0.0.1",
    "viewerUrl": "",
    "viewerUrls": {
      "videoOverlay": "http://localhost:8080/video_overlay.html"
    },
    "views": {
      "videoOverlay": {
        "viewerUrl": "http://localhost:8080/video_overlay.html",
        "canLinkExternalContent": false
      },
      "config": {
        "viewerUrl": "http://localhost:8080/config.html",
        "canLinkExternalContent": false
      }
    },
  ...
  "frontendFolderName": "/Users/montanawong/Code/twitch/sengage/sengames2/sengames-twitch-extension",
  "name": "Sengames2"
}
```
Change `frontendFolderName` to where your project will live.
